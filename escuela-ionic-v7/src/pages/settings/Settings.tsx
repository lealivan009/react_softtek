import { IonContent, IonItem, IonLabel, IonList, IonPage, IonCard, IonSearchbar, IonIcon, IonToggle, IonButton, IonCol, IonGrid, IonRow } from "@ionic/react";
import React from "react";
import Header from "../../components/header/Header";
import './Settings.css';
import { accessibility, airplane, bluetooth, build, cellular, hourglass, key, keypad, list, logIn, logoCapacitor, logOut, moon, notifications, personAdd, radio, sunny, volumeHigh, warning, wifi } from "ionicons/icons";
                    ...
                    <IonRow>
                        <IonCol sizeLg='6' sizeSm='12' offsetLg='3'>
                            ...
                            */}
                                        ...
                                        <IonItem button routerLink="/changePassword">
                                            <div className="icon danger-background">
